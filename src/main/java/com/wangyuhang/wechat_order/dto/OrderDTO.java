package com.wangyuhang.wechat_order.dto;
...
import com.wangyuhang.wechat_order.util.Date2LongSerializer;
...
@Data
@JsonInclude(JsonInclude.Include.NON_NULL) //转换为Json时只返回不为null的属性
public class OrderDTO {
    ...
    @JsonIgnore
    public OrderStatusEnum getOrderStatusEunm(){
